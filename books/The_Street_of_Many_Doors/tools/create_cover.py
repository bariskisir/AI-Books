#!/usr/bin/env python3
"""Cover: Dim Prague street with a dozen glowing colored doors lining cobblestones, small figure at blue door threshold, terracotta wall/door multicolor/cobblestone gray."""
...
def draw_doors(draw: ImageDraw) -> None:
    ...
    # Small figure at the blue door threshold (first door)
    fig_x = start_x + door_w // 2
    fig_y = y + door_h
    # Shadow
    draw.ellipse([fig_x - 20, fig_y - 5, fig_x + 20, fig_y + 5], fill=(20, 18, 15, 120))
    # Body
    draw.line([(fig_x, fig_y), (fig_x, fig_y - 60)], fill=(25, 22, 20), width=10)
    # Head
    draw.ellipse([fig_x - 10, fig_y - 78, fig_x + 10, fig_y - 60], fill=(30, 28, 25))
    # Arm reaching for door handle
    draw.line([(fig_x + 5, fig_y - 40), (fig_x + 40, fig_y - 50)], fill=(25, 22, 20), width=5)

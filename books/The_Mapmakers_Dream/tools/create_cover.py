#!/usr/bin/env python3
"""Cover: The Mapmaker's Dream — Cartographer at riverbank before mist-shrouded walled city rising from jungle, parchment gold/jungle green/mist white."""
...
def main() -> None:
    ...
    # Cartographer figure at riverbank
    fig_x, fig_y = 320, 780
    # Body
    draw.polygon([
        (fig_x - 8, fig_y), (fig_x + 8, fig_y),
        (fig_x + 10, fig_y + 45), (fig_x - 10, fig_y + 45),
    ], fill=(60, 50, 40, 200))
    # Head
    draw.ellipse([fig_x - 6, fig_y - 18, fig_x + 6, fig_y - 6], fill=(70, 55, 40, 200))
    # Hat
    draw.ellipse([fig_x - 10, fig_y - 26, fig_x + 10, fig_y - 17], fill=(40, 35, 30, 200))
    # Arm holding map
    draw.line([(fig_x + 8, fig_y + 5), (fig_x + 25, fig_y + 15)], fill=(60, 50, 40, 200), width=3)
    # Map/notebook in hand
    draw.rectangle([fig_x + 22, fig_y + 8, fig_x + 38, fig_y + 28], fill=(220, 210, 180, 180), outline=(180, 170, 140, 150))
    # Legs
    draw.line([(fig_x - 4, fig_y + 45), (fig_x - 8, fig_y + 65)], fill=(50, 42, 35, 200), width=3)
    draw.line([(fig_x + 4, fig_y + 45), (fig_x + 8, fig_y + 65)], fill=(50, 42, 35, 200), width=3)

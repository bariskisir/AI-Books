#!/usr/bin/env python3
"""Cover: The Harmony Engine — Dark city skyline at dusk, glowing blue spire, floating wellbeing score displays, indigo/cyber blue/amber."""
...
def create_cover(metadata_path: Path, output_path: Path) -> None:
    ...
    skyline_color = (15, 18, 30)
    for bx, bw, bh in [
        (50, 80, 500), (150, 100, 400), (280, 70, 550), (380, 120, 450),
        (540, 90, 350), (660, 110, 500), (800, 130, 300), (970, 80, 480),
        (1080, 100, 520), (1220, 110, 400), (1360, 90, 450), (1480, 100, 350),
    ]:
        draw.rectangle((bx, 1500 - bh, bx + bw, 1500), fill=skyline_color)

    # Glowing blue spire at center
    spire_x = WIDTH // 2
    spire_base = 1500
    spire_top = 300
    # Spire glow
    for r in range(100, 10, -10):
        alpha = max(0, 60 - (100 - r) // 2)
        draw.ellipse((spire_x - r, spire_top - r, spire_x + r, spire_top + r), fill=(60, 140, 255, alpha))
    # Spire body
    draw.polygon([
        (spire_x - 8, spire_top), (spire_x + 8, spire_top),
        (spire_x + 25, spire_base), (spire_x - 25, spire_base),
    ], fill=(40, 100, 220, 200))
    # Spire tip light
    draw.ellipse((spire_x - 12, spire_top - 12, spire_x + 12, spire_top + 12), fill=(100, 200, 255, 220))

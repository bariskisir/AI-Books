#!/usr/bin/env python3
"""Cover: The Fifth Season — Greek island landscape, Aegean sea, warm Mediterranean tones, blue sky, white buildings."""
...
def make_cover(metadata_path: Path, output_path: Path) -> None:
    ...
    # Gradient sky: deep Aegean blue at top to warm Mediterranean horizon
    for y in range(H):
        t = y / H
        if y < 800:
            r = int(20 + 60 * (y / 800))
            ...
            r = int(80 + 40 * ((y - 800) / 400))
            g = int(160 + 40 * ((y - 800) / 400))
            b = int(180 - 60 * ((y - 800) / 400))
        else:
            t2 = (y - 1200) / 1360
            r = int(120 - 80 * t2)
            g = int(200 - 140 * t2)
    ...
    # Additional white buildings cascading down hillside
    for bdx, bdy, bw, bh in [(480, 1120, 35, 40), (440, 1140, 30, 30), (880, 1110, 40, 50), (920, 1130, 35, 35), (650, 1130, 45, 35)]:
        draw.rectangle((bdx, bdy - bh, bdx + bw, bdy), fill=(235, 240, 245, 200))
        draw.rectangle((bdx + 6, bdy - bh + 8, bdx + bw - 6, bdy - bh + 20), fill=(40, 130, 190, 160))

    # Blue-domed church on far left
    draw.rectangle((100, 1060, 160, 1120), fill=(230, 235, 240, 200))
    draw.ellipse((110, 1040, 150, 1070), fill=(30, 100, 180, 200))

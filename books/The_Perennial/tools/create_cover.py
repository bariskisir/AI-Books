...
def _draw_standard_cover_title_panel(image, title="", author=""):
    ...
    draw.line((180, PY + 17, W - 180, PY + 17), fill=(160, 140, 200, 105), width=3)
    ...
    y = _standard_cover_center(draw, y, lines, tf, (220, 210, 230), tg, W)
    y += 120
    _standard_cover_center(draw, y, [author], af, (180, 160, 200), 12, W)

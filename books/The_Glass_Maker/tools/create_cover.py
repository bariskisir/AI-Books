#!/usr/bin/env python3
"""Cover: The Glass Maker — Warm amber/crimson Venetian canal, gondola silhouette, furnace glow with ruby glass, amber/dark crimson/canal green."""
...
def make_cover(mp,op):
    ...
    # Canal at midground — dark green water
    for y in range(900, 1300):
        t=(y-900)/400
        draw.line((0,y,W,y), fill=(int(20+10*t),int(35-15*t),int(30-5*t),200))

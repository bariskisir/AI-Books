#!/usr/bin/env python3
"""Generate a 1600x2560 PNG cover for The Half-Life of Love."""
...
def draw_gradient(draw: ImageDraw, width: int, height: int) -> None:
    """Deep blue-black to warm terracotta gradient for science-romance feel."""
    for y in range(height):
        if y < height * 0.4:
            t = y / (height * 0.4)
            c = lerp_color((5, 5, 30), (10, 20, 60), t)
        elif y < height * 0.7:
            t = (y - height * 0.4) / (height * 0.3)
            c = lerp_color((10, 20, 60), (100, 55, 40), t)
        else:
            t = (y - height * 0.7) / (height * 0.3)
            c = lerp_color((100, 55, 40), (50, 25, 18), t)

#!/usr/bin/env python3
"""Cover: The Glass Concord — Glass towers at dawn, lone woman on transparent causeway over crystalline city, pale blue/rose gold/white."""
...
def main():
    ...
    # Lone woman on transparent causeway — center foreground
    wx, wy = WIDTH // 2, base_y + 30
    # Her silhouette
    w_color = (40, 45, 55, 200)
    draw.ellipse((wx - 8, wy - 40, wx + 8, wy - 20), fill=w_color)  # head
    draw.polygon([(wx - 12, wy - 20), (wx + 12, wy - 20), (wx + 14, wy + 20), (wx - 14, wy + 20)], fill=w_color)  # body
    # Dress/coat flowing
    draw.polygon([(wx - 14, wy + 10), (wx + 14, wy + 10), (wx + 20, wy + 30), (wx - 20, wy + 30)], fill=w_color)
    # Transparent causeway — glass floor beneath her
    draw.line((wx - 60, wy + 32, wx + 60, wy + 32), fill=(200, 210, 230, 80), width=3)
    draw.line((wx - 40, wy + 35, wx + 40, wy + 35), fill=(180, 200, 220, 60), width=2)
    # Reflection beneath
    for y_off in range(5, 40, 4):
        alpha = max(0, 30 - y_off)
        draw.line((wx - 10, wy + 32 + y_off, wx + 10, wy + 32 + y_off), fill=(160, 180, 210, alpha), width=1)

#!/usr/bin/env python3
"""Cover: The Orchid Thief of Calcutta — glowing seven-petaled orchid with ember-orange petals against dark jungle green."""
...
def create_cover(metadata_path: Path, output_path: Path) -> None:
    ...
    # Emerald to violet jungle gradient
    draw_gradient(draw, WIDTH, HEIGHT)
    # Jungle canopy and hanging vines
    draw_jungle_canopy(draw, WIDTH, HEIGHT)
    # Colonial bungalow
    draw_botanical_garden_bungalow(draw, WIDTH, HEIGHT)
    # Glowing seven-petaled orchid with ember-orange petals
    draw_orchid(draw, WIDTH, HEIGHT)
    # Floating ember light particles

...
def _draw_standard_cover_title_panel(image, title="", author=""):
    ...
    draw.line((180, PY + 17, W - 180, PY + 17), fill=(80, 200, 220, 105), width=3)
    ...
    y = _standard_cover_center(draw, y, lines, tf, (200, 230, 240), tg, W)
    y += 120
    _standard_cover_center(draw, y, [author], af, (100, 200, 220), 12, W)

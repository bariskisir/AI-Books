#!/usr/bin/env python3
"""Cover: The Noise Between Stars — Arkadia silhouette against CMB, glowing signal lines through star field."""
...
def main() -> None:
    ...
    # CMB band
    draw_cmb_map(draw)
    # Glowing signal lines radiating through star field
    draw_signal_waves(draw)
    # Planet
    draw_planet(draw)
    draw_rings(draw)
    # Arkadia observation deck silhouette
